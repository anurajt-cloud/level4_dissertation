...
def getlstmModel(i1, i2):
    
    lstmmodel = Sequential()
    lstmmodel.add(LSTM(128, return_sequences=True, input_shape=(i1,i2)))
...
for train_ix, test_ix in kfold.split(X, y):
    ...
    tl, vl, ta, va = training(model, train_x_sampled, train_y_sampled, batch_size)
